package cn.edu.ccibe.alst.ui.view;
...
import cn.edu.ccibe.alst.databinding.SimpleDialogLayoutBinding;
...
public class SimpleDialogView extends DialogFragment {
    ...
    public SimpleDialogView setDialogContentView(View dialogContentView) {
