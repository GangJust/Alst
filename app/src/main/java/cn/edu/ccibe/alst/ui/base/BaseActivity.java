package cn.edu.ccibe.alst.ui.base;
...
import cn.edu.ccibe.alst.databinding.ToastLayoutBinding;
import cn.edu.ccibe.alst.net.NetUtil;
import cn.edu.ccibe.alst.ui.utils.StatusBarUtil;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected static SharedPreferences.Editor spEditor;
    ...
    private void _initSp(){
        sp = SharedPreferencesUtil.getSp(getApplicationContext());
        spEditor = SharedPreferencesUtil.getEditor(getApplicationContext());
    }
