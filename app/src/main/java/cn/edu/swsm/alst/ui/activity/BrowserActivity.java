...
import cn.edu.swsm.alst.databinding.ActivityBrowserBinding;
import cn.edu.swsm.alst.net.NetHeaderUtil;
import cn.edu.swsm.alst.ui.base.BaseActivity;
import cn.edu.swsm.alst.ui.utils.DisplayUtil;
...
public class BrowserActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        webSettings.setUserAgentString(NetHeaderUtil.UserAgents.PhoneQQ_8_5_5);
    ...
    private boolean onHelper() {
        ...
        if (webViewHelper.isImage()) {
            ...
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout
                    .LayoutParams(DisplayUtil.dip2px(this, 160f), DisplayUtil.dip2px(this, 200f));
